---
name: weekly-brief
description: Brief me on my week, my day, or what to focus on. Use for "brief me", "what's on my week", "what should I focus on", "my day", "catch me up", morning briefing. 用于"简报"、"汇报"、"本周"、"今天"、"关注"、"重点"、"进展"、"早间简报"：汇报本周、今天的安排，或者该关注的重点。
---
