// syrup dashboard — Model arena: race ONE message through several models at once.
...
try {
  const saved = JSON.parse(localStorage.getItem("syrup_compare") || "null");
...
function saveCompare(){
  try { localStorage.setItem("syrup_compare", JSON.stringify({
...
// Write to the real Apple Calendar ('Syrup' calendar), opt-in. OFF by default so
...
// syrup/ops/memory_arena.py::_available_backends is now the only one.
function maBackends(){
