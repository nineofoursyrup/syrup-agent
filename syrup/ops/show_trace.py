"""`python -m syrup.ops.show_trace` — read a JSONL trace as a terminal timeline.

Pass a trace file directly, or omit it to show the most recent trace in SYRUP_HOME
(the current directory's .syrup/ by default). Trace records are printed one at a
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Render a Syrup JSONL trace as a terminal timeline."
    )
    parser.add_argument(
