...
Two kinds of graph ship in Syrup and conflating them made the UI say something
...
DISCOVERY, and why it is shaped this way: a module in syrup/graph/workflows/ is
...
makes it testable. What makes a workflow runnable is its BINDER in syrup/ops/,
where real callables meet the pure shape.

So the rule is: `syrup/graph/workflows/<name>.py` plus `syrup/ops/<name>.py`
