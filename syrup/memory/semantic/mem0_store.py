"""Semantic memory, hosted — Mem0 behind the same six methods as everything else.
    ...
    SYRUP_SEMANTIC_STORE=mem0   MEM0_API_KEY=m0-...

Syrup's own store is FTS5 keyword search; Supabase is embeddings you host. Mem0
...
# Every fact Syrup stores belongs to the one person running it, and Mem0 scopes
...
class Mem0FactStore:
    ...
    # Syrup keeps subject and content apart; Mem0 stores one blob. Round-tripping
