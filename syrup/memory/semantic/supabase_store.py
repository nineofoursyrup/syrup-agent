...
`match_chunks` RPC from a standard Supabase pgvector RAG setup. Run
sql/init_supabase.sql on a fresh project, then:

    pip install 'syrup-agent[supabase]'
    SYRUP_SEMANTIC_STORE=supabase  SUPABASE_URL=...  SUPABASE_SERVICE_KEY=...
