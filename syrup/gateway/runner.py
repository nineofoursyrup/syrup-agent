"""One thread-owned Syrup per asynchronous message gateway.

Telegram and Discord are async clients, while Syrup is deliberately synchronous
...
GATEWAY_ERROR_REPLY = "Syrup couldn't process that message. Check the dashboard terminal."
