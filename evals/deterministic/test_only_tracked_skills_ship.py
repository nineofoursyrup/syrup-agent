...
Caught while building 0.1.3. The wheel contained four skills:
    ...
    meeting-prep · schedule-meeting · weekly-brief · personal-notes-draft

Those are the names as they stood that day; the first two have since been
renamed to find-skills and schedule-pin. Left as they were, because this
paragraph records what the 0.1.3 wheel actually contained.

The last one was a personal, non-project skill directory. It was never
...
Personal skills belong in `~/.syrup/skills/`, which syrup already reads and which
...
def test_every_skill_on_disk_is_tracked():
    ...
    assert untracked == set(), (
        ...
        "If it is a personal skill, move it to ~/.syrup/skills/ (syrup reads that "
