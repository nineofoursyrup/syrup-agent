...
from syrup.graph import END, run_graph
from syrup.graph.workflows.gather import (
    SCAN_KEYS,
    build_gather_graph,
    gather_topology,
    needs_action,
...
def test_the_workflow_cannot_act():
    ...
    """
    from syrup.graph.workflows import gather as workflow
    from syrup.ops import gather as binder
