-- Directory: syrup-agent/sql/init_supabase.sql
-- A standard Supabase pgvector RAG schema, reused unchanged so the vector
-- upgrade path matches a well-known reference implementation.
--
